...
DROP INDEX resulthorse_nimi_idx;
...
CREATE TABLE PROGRAMHORSE (
	...
	YHT_S NUMBER ( 3 ) NOT NULL,
	XCODE NUMBER ( 3 ) NOT NULL,
	KCODE NUMBER ( 3 ) NOT NULL,
	YHT_1 NUMBER ( 3 ) NOT NULL,
	YHT_2 NUMBER ( 3 ) NOT NULL,
	YHT_3 NUMBER ( 3 ) NOT NULL,
	YHT_R NUMBER ( 10 ) NOT NULL,
	V_S NUMBER ( 3 ) NOT NULL,
	V_1 NUMBER ( 3 ) NOT NULL,
	V_2 NUMBER ( 3 ) NOT NULL,
	V_3 NUMBER ( 3 ) NOT NULL,
	V_R NUMBER ( 10 ) NOT NULL,
