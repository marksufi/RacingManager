...
public class SubStart implements Comparable {
    ...
    public SubStart(String subStart, RaceProgramHorse raceProgramHorse) {
        ...
        try {
            ...
            if (subStart != null) {
                ...
                if(xCode.toString().contains("null"))
    ...
    public static PreparedStatement getInsertStatement(Connection conn) {
        ...
        try {
            ...
            sb.append("(NIMI, LAJI, KULJETTAJA, VALMENTAJA, PAIKKA, WEATHER, PVM, LAHTONUMERO, MATKA, RATA, TYYPPI, AIKA, KCODE, LAHTOTYYPPI, SIJOITUS, S_1, S_2, S_3, XCODE, KERROIN, PALKINTO) ");
            sb.append("values(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
    ...
    public void insert(Connection conn, String hid, RaceResultHorse raceResultHorse) throws ExistsInDatabaseException {
        ...
        try {
            ...
            StringBuffer sb = new StringBuffer();
            sb.append("insert into SUBRESULT ");
            sb.append("(NIMI, LAJI, OHJELMAKULJETTAJA, VALMENTAJA, PAIKKA, PVM, EXPVM, LAHTONUMERO, MATKA, RATA, TYYPPI, AIKA, KCODE, LAHTOTYYPPI, SIJOITUS, S_1, S_2, S_3, XCODE, KERROIN, PALKINTO, TAUKOVIIKOT) ");
            sb.append("values(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
