                    ...
                    if ((line = raceLinkPage.readBlock("tr")) != null) {
                        ...
                        while ((line = raceLinkPage.findBefore("tr", "</div>")) != null) {
                            ...
                            try {
                                        ...
                                        switch (i) {
                                            ...
                                            case 3: // L�h
                                                try {
                                                    ...
                                                    // Korvaus j�rjest�j�n virheest�
                                                    subStart.setSubTime(new SubTime("P"));
                                                    //i = 15; // lopetus
                                                    throw new AbsentException(subStart.toString());
                                                }
                                                break;
                                            ...
                                            case 10: // X koodi
                                                ...
                                                if (xCode.length() > 8) {
                                                    xCode = xCode.strip();
                                                    xCode = xCode.trim();
                                                    System.out.println("Liian iso x-koodi: " + xCode);
                                                }
                                ...
                                Log.write(e, "RaceHorseHistoryParser.parse(" + raceProgramHorse.getRaceHorseName() + ") " + subStart.getId());
                            }
                        }
                    }
                }
