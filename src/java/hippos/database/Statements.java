...
public class Statements {
    ...
    public static PreparedStatement getSubStartsStatement(Connection conn, RaceProgramHorse raceProgramHorse, int rowCount) {
        ...
        try {
            ...
            stmt.append("select r.RATA_TUNNISTE, s.WEATHER, s.KULJETTAJA, s.KVP, s.VALMENTAJA, s.PAIKKA, s.PVM, s.LAHTONUMERO, s.MATKA, s.RATA, s.TYYPPI, s.AIKA, s.LAHTOTYYPPI, s.SIJOITUS, s.XCODE, s.X, s.KERROIN, s.PALKINTO, s.KCODE ");
